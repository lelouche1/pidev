 ...
 * @author lelou
 */
public class ConsulterAgenceController implements Initializable {
    ...
    private TextField textfiel_recherche;
        ...
        @FXML
    private Button btn_retourReservation;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        @FXML
    void btn_retourReservation(ActionEvent event) {
                    try {
                        ...
                        Stage stage = (Stage) btn_retourReservation.getScene().getWindow();
